...
| 5. Lessons and lifecycle | Lesson CRUD/reordering plus publish/archive/restore transitions. | Ordering, ownership, lifecycle, and last-lesson tests. | 1.5 h | Pending |
| 6. Enrollment/progress | Enrollment, timestamps, derived course progress. | Constraints and progress-transition tests. | 2 h | Pending |
| 7. Catalogue/discussion/history | Learner catalogue, comments, immutable history. | Pagination/access tests. | 1.5 h | Pending |
| 8. Reporting and finish | CSV, dashboard, alerts, integration, deployment. | End-to-end smoke tests. | 1.5 h | Pending |
