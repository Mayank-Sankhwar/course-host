...
export function CourseManager() {
  ...
  async function loadCourses() {
    try {
      ...
      const alerts = await courseApi.alertCount();
  ...
  return (
    <section>
      <h2>My courses <small>Alerts: {alertCount}</small></h2>
      ...
      {activityCourse && <ActivityManager courseId={activityCourse.id} courseTitle={activityCourse.title} />}
    </section>
  );
}
